        ...
        <div className="w-full max-w-md bg-white dark:bg-darkbg-secondary rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-slate-200 dark:border-slate-800 overflow-hidden transition-all duration-300">
          <div className="p-8">
            ...
            <form onSubmit={handleAuth} className="space-y-4">
              ...
              <div className="flex items-start gap-3 py-3 group cursor-pointer" onClick={() => setAcceptedTerms(!acceptedTerms)}>
                <div className={cn(
                  "relative w-5 h-5 rounded-md border-2 transition-all duration-200 flex items-center justify-center",
                  acceptedTerms
                    ? "bg-brand border-brand shadow-[0_0_10px_rgba(0,166,147,0.4)]"
                    : "bg-white dark:bg-darkbg-primary border-slate-300 dark:border-slate-700 group-hover:border-brand"
                )}>
                  {acceptedTerms && (
                ...
                <label className="text-xs text-slate-500 dark:text-slate-400 leading-tight cursor-pointer select-none">
                  I agree to the <Link href="/terms" className="text-brand hover:underline font-medium">Terms of Service</Link> and <Link href="/privacy" className="text-brand hover:underline font-medium">Privacy Policy</Link>
                </label>
              </div>
